      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-6 py-6 pb-24 flex flex-col gap-6">
        ...
        <div className="bg-white p-1 rounded-2xl border border-slate-100 shadow-sm flex flex-col">
          <div className="flex items-center gap-3 p-3 border-b border-slate-50">
            <div className="bg-slate-50 p-2 rounded-xl text-slate-500 flex items-center justify-center">
              <img src="https://cdn-icons-png.flaticon.com/512/2965/2965306.png" alt="Email" className="w-[18px] h-[18px] object-contain" />
            </div>
          ...
          <div className="flex items-center gap-3 p-3">
            <div className="bg-slate-50 p-2 rounded-xl text-slate-500 flex items-center justify-center">
              <img src="https://cdn-icons-png.flaticon.com/512/3178/3178284.png" alt="Phone" className="w-[18px] h-[18px] object-contain" />
            </div>
            <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
            <MenuRow iconUrl="https://cdn-icons-png.flaticon.com/512/3125/3125856.png" label="Attendance" onClick={ () => setCurrentScreen('attendance') } />
            <MenuRow iconUrl="https://cdn-icons-png.flaticon.com/512/4252/4252365.png" label="Privacy Policy" onClick={ () => setCurrentScreen('privacy') } />
            <MenuRow iconUrl="https://cdn-icons-png.flaticon.com/512/16311/16311864.png" label="Help & Support" onClick={ () => setCurrentScreen('help') } />
            <MenuRow iconUrl="https://cdn-icons-png.flaticon.com/512/10024/10024306.png" label="Settings" onClick={ () => setCurrentScreen('settings') } />
          </div>
        </div>
...
const MenuRow = ({ iconUrl, label, onClick }) => (
  <button onClick={ onClick } className="flex items-center justify-between px-3 py-2.5 bg-white hover:bg-slate-50 border-b border-slate-50 last:border-0 transition-colors w-full text-left">
    <div className="flex items-center gap-3 text-slate-700">
      <div className="bg-slate-100 p-1.5 rounded-lg flex items-center justify-center">
        <img src={iconUrl} alt={label} className="w-[18px] h-[18px] object-contain" />
      </div>
