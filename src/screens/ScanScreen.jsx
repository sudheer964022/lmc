            ...
            <div className="space-y-2.5">
              ...
              <div className="flex gap-2 pt-2">
                <button
                  ...
                  className="flex-1 py-2.5 px-3 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors"
                >
                  Scan Another
                </button>
                <button
                  onClick={() => setCurrentScreen('home')}
                  className="flex-1 py-2.5 px-3 rounded-xl text-xs font-bold text-white bg-blue-700 hover:bg-blue-800 transition-colors shadow-md shadow-blue-700/25"
                >
                  Confirm & Collect All
                </button>
              </div>
